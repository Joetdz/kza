...
export const sampleProducts: Product[] = [
  { id: p1, name: 'Nike Air Force 1', sku: 'KZA-001', category: 'Chaussures',
    quantity: 45, alertThreshold: 10, supplier: 'Nike Maroc', trackStock: true,
  ...
  { id: p2, name: 'Jordan 1 Retro High', sku: 'KZA-002', category: 'Chaussures',
    quantity: 12, alertThreshold: 5, supplier: 'Jordan Distribution', trackStock: true,
  ...
  { id: p3, name: 'Sac Cuir Argan', sku: 'KZA-003', category: 'Maroquinerie',
    quantity: 8, alertThreshold: 3, supplier: 'Artisan Fès', trackStock: true,
  ...
  { id: p4, name: 'Adidas Stan Smith', sku: 'KZA-004', category: 'Chaussures',
    quantity: 3, alertThreshold: 5, supplier: 'Adidas Maroc', trackStock: true,
  ...
  { id: p5, name: 'Ceinture Cuir Artisan', sku: 'KZA-005', category: 'Maroquinerie',
    quantity: 25, alertThreshold: 5, supplier: 'Artisan Marrakech', trackStock: true,
  ...
  { id: p6, name: 'Lunettes Oversize', sku: 'KZA-006', category: 'Accessoires',
    quantity: 50, alertThreshold: 10, supplier: 'Import Dubai', trackStock: true,
  ...
  { id: p7, name: 'Montre Casio G-Shock', sku: 'KZA-007', category: 'Accessoires',
    quantity: 15, alertThreshold: 3, supplier: 'Casio Distributeur', trackStock: true,
  ...
  { id: p8, name: 'Parfum Oud Royal', sku: 'KZA-008', category: 'Beauté',
    quantity: 7, alertThreshold: 5, supplier: 'Oud Palace', trackStock: true,
